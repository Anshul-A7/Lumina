...
Located in [`src/components/dashboard/MdxEditorComponent.tsx`](./frontend/src/components/dashboard/MdxEditorComponent.tsx):
...
Located in [`src/components/dashboard/WorkspaceView.tsx`](./frontend/src/components/dashboard/WorkspaceView.tsx):
...
Located in [`src/app/dashboard/page.tsx`](./frontend/src/app/dashboard/page.tsx) and [`src/components/chat/RichMessage.tsx`](./frontend/src/components/chat/RichMessage.tsx):
- **Streaming Response Renderer**: Renders markdown, tables, headings, and code blocks with copy-to-clipboard actions.
- **PDF Document Card**: When an AI response includes a document, it renders [`PdfDocumentCard.tsx`](./frontend/src/components/dashboard/PdfDocumentCard.tsx) with direct Preview, Edit in Word Editor, and Download actions.
